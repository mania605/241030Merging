...
export default function Product() {
	...
	useEffect(() => {
		ref_product.current.classList.remove('on');

		setTimeout(() => {
			ref_product.current.classList.add('on');
		}, 800);
	}, [Type]);
		...
		<>
			<Layout title={'GALLERY'}>
				...
				<p>This web page was created for study purposes, not for commercial use</p>
					<p>The Images below are sourced from unplash.com</p>
					...
					<section className='galleryList' ref={ref_product}>
